...
{
    public sealed class MongoSetDefinition<TDocument>
        where TDocument : IMongoAggregate<TDocument>
    {
        ...
        public MongoSetDefinition<TDocument> HasIndex(
        ...
        public IMongoSet<TDocument> ToDbCollection()
        {
